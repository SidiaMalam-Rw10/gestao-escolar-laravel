    ...
    <form method="POST" action="{{ route('admin.turmas.store') }}">
        ...
        <div class="form-grid">
            <div class="form-group full-width"><label class="form-label">Nome da Turma <span class="required">*</span></label>
                <input type="text" name="nome_turma" value="{{ old('nome_turma') }}" class="form-input @error('nome_turma') is-invalid @enderror" required autofocus placeholder="Ex: 7ª Classe A">
            ...
            <div class="form-group"><label class="form-label">Nível <span class="required">*</span></label>
                <input type="text" name="nivel" value="{{ old('nivel') }}" class="form-input @error('nivel') is-invalid @enderror" required placeholder="Ex: 7ª Classe">
        ...
        <div class="form-actions">
            <button type="submit" class="btn-primary"><i class="fas fa-save"></i> Criar Turma</button>
