...
<body>
    ...
    <div class="title">
        <h1>Relatório de Presenças — {{ $professor->name }}</h1>
    ...
    <div class="info-grid">
        <div class="item">
            ...
            <div class="v">{{ $professor->disciplina ?: '—' }}</div>
        </div>
        <div class="item">
            <div class="k">Nível</div>
            <div class="v">{{ $professor->nivel ?: '—' }}</div>
        </div>
        <div class="item">
    ...
    <div class="footer">
        ...
        <span>Sistema de Presenças de Professores</span>
    </div>
</body>
</html>