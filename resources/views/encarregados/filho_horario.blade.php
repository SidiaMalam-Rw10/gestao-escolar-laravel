...
@section('title', 'Horário do Filho')
@section('page-title', 'Horário do Filho')
...
<style>
    ...
    @media print{
        aside,header,.doc-toolbar,.filho-card{display:none !important}
...
@include('encarregados._filho_header', ['aluno' => $aluno, 'filhos' => $filhos, 'secao' => 'horario'])
...
<div class="hz-doc">
    ...
    <div class="info-section">
        ...
        <div class="info-column" style="text-align:right">
            ...
            <p><strong>Turno:</strong> {{ $turma->periodo }}</p>
            <p><strong>Ano Letivo:</strong> {{ $turma->ano_lectivo }}</p>
        </div>
    </div>

    <div class="schedule-card">
        <h2 class="schedule-title">HORÁRIO SEMANAL DA TURMA {{ $turma->nome_turma }}</h2>
...
<div class="empty-card">
    ...
    <div>O seu filho ainda não está associado a nenhuma turma.</div>
</div>
@else
<div class="empty-card">
    <i class="fas fa-calendar-times"></i>
    <div>Não há horários atribuídos para a turma do seu filho.</div>
</div>
@endif
@endsection
