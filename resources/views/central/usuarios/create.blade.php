...
<div class="form-card">
    <form method="POST" action="{{ route('central.usuarios.store') }}">
        @csrf
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" class="form-input @error('name') is-invalid @enderror" required maxlength="150" autofocus>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input type="text" name="telefone" value="{{ old('telefone') }}" class="form-input @error('telefone') is-invalid @enderror" maxlength="30" placeholder="ex.: +244 900 000 000">
                </div>
        ...
        <div class="form-grid">
            <div class="form-group">
                ...
                <div class="input-icon">
                    ...
                    <input type="password" name="password" class="form-input @error('password') is-invalid @enderror" required minlength="8" autocomplete="new-password">
                </div>
        ...
        <div class="form-actions">
            <button type="submit" class="btn-primary"><i class="fas fa-user-plus"></i> Criar Utilizador</button>
