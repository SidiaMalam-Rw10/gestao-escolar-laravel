...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; }
        ...
        .hint { font-size: 13px; color: var(--text-secondary); margin-bottom: 20px; line-height: 1.5; }
        .email-box { font-size: 13px; color: var(--accent-green); font-weight: 600; padding: 10px 14px; background: rgba(34, 197, 94, 0.06); border: 1px solid rgba(34, 197, 94, 0.2); border-radius: 8px; margin-bottom: 20px; }
...
<body>
    <div class="auth-card">
        ...
        @if($email)
        <div class="email-box"><i class="fas fa-envelope"></i> {{ $email }}</div>
        @endif
        ...
        <form method="POST" action="{{ route('password.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" required autofocus placeholder="Mínimo de 8 caracteres" class="form-input">
            </div>
            ...
            <button type="submit" class="btn-login"><i class="fas fa-key" style="margin-right: 6px;"></i>Repor palavra-passe</button>
        </form>
