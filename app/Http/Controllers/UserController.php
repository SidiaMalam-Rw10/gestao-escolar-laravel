...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'role' => 'required|in:admin,diretor,financeiro,professor,aluno,auxiliar,pctp,encarregado',
            'roles' => 'nullable|array',
            'roles.*' => 'in:admin,diretor,financeiro,professor,aluno,auxiliar,pctp,encarregado',
            'numero' => [
